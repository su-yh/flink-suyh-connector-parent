...
public class DuckdbRecordBuffer {
    private static final Logger LOG = LoggerFactory.getLogger(DuckdbRecordBuffer.class);
    ...
    public DuckdbRecordBuffer(int capacity, int queueSize) {
